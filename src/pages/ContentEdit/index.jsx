...
const EditContent = () => {
    ...
    const [checkboxNewVersionStatus, setNewVersionCheckBoxStatus] = useState(false);
    ...
    useEffect(() => {
        ...
        contentEditUtils.getSingleContent(contentTypeID, contentID, incomingData => {
    ...
    return (
        <Flex alignItems="center" w="100%" wrap={'wrap'} h={'auto'} direction={'column'} p={6}>
                    ...
                    {props => (
                        <>
                            <Flex w={'100%'} justifyContent={'space-evenly'} gap={4}>
                                ...
                                <Spacer />
                                <If test={userRole === 'Admin' || userRole === 'Editor'}>
                                    <DeleteAlertForContent deletedItem={`Content ID:${contentID}`} />
                                </If>
                                ...
                                <Modal isOpen={isOpen} size="5xl" onClose={onClose}>
                                    <ModalOverlay />
                                    <ModalContent>
                                        <ModalHeader>Versions of Content</ModalHeader>
                                        <ModalCloseButton />
                                        <ModalBody>
                                            <TableContainer>
                                                <Table variant="simple">
                                                    <TableCaption>
                                                        You can change your content active version from here.
                                                    </TableCaption>
                                                    <Thead>
                                                        <Tr>
                                                        ...
                                                        {versionList?.map(data => {
                                                            return (
                                                                <Tr>
                                                                    ...
                                                                    <Td textAlign={'center'} key={data.id}>
                                                                        {data.created_at}
                                                                    </Td>
                                        ...
                                        <ModalFooter>
                                            <Button colorScheme="red" px={10} mr={3} onClick={onClose}>
                                                Close
                                            </Button>
                                        </ModalFooter>
                                    </ModalContent>
                            ...
                            <Form>
                                ...
                                <Field name="tags" validate={addContentUtils.validateTagsInputWithRegex}>
                                    {({ field, form }) => (
                                        <FormControl
                                            w={'40%'}
                                            minW={'250px'}
                                ...
                                <Flex
                                    ...
                                    w="100%"
                                >
                                    <Checkbox defaultChecked={publishStatus} onChange={e => checkboxClickHandler(e)}>
                                        Is Published ?
                                    </Checkbox>
                                    <Spacer />
                                    <Checkbox
                                ...
                                <Flex
                                    ...
                                    w="100%"
                                >
                                    <Button minW={'250px'} w="50%" size={'md'} colorScheme="blue" type="submit">
                                        Update
                                    </Button>
                                </Flex>
                            </Form>
