...
const Content = () => {
    ...
    const handleAddOnClick = () => {
        contentPageUtils.getContentTypeFields(selectedContentTypeID, incomingData => {
    ...
    const listOnClickHandler = () => {
        contentPageUtils.fillContentsTable(search, tags, selectedContentTypeID, incomingData => {
    ...
    const searchHandle = () => {
        ...
        contentPageUtils.fillContentsTable(searchInputValue, searchByTagsValue, selectedContentTypeID, incomingData => {
            if (incomingData.length === 0) {
                setIsEmpty(true);
            } else {
                setIsEmpty(false);
        ...
        <VStack>
            ...
            >
                <VStack w={'100%'}>
                    ...
                    <Flex w={'100%'} wrap="wrap" alignItems={'center'} justifyContent={'space-evenly'}>
                        <Button
                            disabled={isDisabled}
                            minW={'250px'}
                            size={'md'}
                        ...
                        <Spacer />
                        <Button disabled={isDisabled} minW={'250px'} size={'md'} onClick={handleAddOnClick}>
                            Create New Content
                        </Button>
                    </Flex>
                </VStack>
          ...
          >
            ...
            <InputGroup>
              ...
              />
                        ...
                        <InputGroup>
                            <Input id="tagsSearchInput" type="search" placeholder="Search Content By Tags" />
                            <Button
                                ml="0.60rem"
                                id="search-button"
